...
@dataclass
class DataConfig:
    dataset_paths = ['xxx/LibriTTS/LibriTTS/train-clean-100',
                     'xxx/LibriTTS/train-clean-360',
                     'xxx/LibriTTS/train-other-500',]
    output_filelist_path = './filelists/filelist.txt'
...
if __name__ == '__main__':
    for data_path in data_config.dataset_paths:
        filelist = []   
        results = []
        ...
        with open(data_config.output_filelist_path, 'a', encoding='utf-8') as f:
