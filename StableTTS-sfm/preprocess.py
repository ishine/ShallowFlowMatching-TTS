...
@dataclass
class DataConfig:
    input_filelist_path = './data/VCTK/vctk_audio_sid_text_train_filelist.txt' # a filelist contains 'audiopath | text'
    output_filelist_path = './filelists/vctk.json' # path to save filelist
    output_feature_path = './VCTK' # path to save resampled audios and mel features
